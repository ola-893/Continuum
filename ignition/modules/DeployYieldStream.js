...
module.exports = buildModule("YieldStreamModule", (m) => {
  ...
  // 1. Deploy the TokenRegistry contract
  const tokenRegistry = m.contract("TokenRegistry", [initialOwner]);
  ...
  m.call(tokenRegistry, "transferOwnership", [rwaHub]);
  m.call(streamingProtocol, "transferOwnership", [rwaHub]);

  return { tokenRegistry, streamingProtocol, rwaHub };
});
